...
public class CoreferenceResolution {
	...
	public static void main(String[] args) throws IOException {
        ...
        String text = "He was educated in Luanda, the capital of Angola, which was then ruled by Portugal. As a young man in 1957 he went to Paris, where he met M�rio Pinto de Andrade, another Angolan poet and politician, who helped with his political ideas. In the 1960s they helped create the group called the Popular Movement for the Liberation of Angola (MPLA--from the Portuguese name Movimento Popular de Liberta��o de Angola).";
