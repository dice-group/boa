...
public class PartOfSpeechTagNormalizer {
	...
	static {
		...
		PART_OF_SPEECH_TAG_MAPPINGS.put("PRO",	"PRO");
		PART_OF_SPEECH_TAG_MAPPINGS.put("C",	"C");
		PART_OF_SPEECH_TAG_MAPPINGS.put("D",	"D");
		PART_OF_SPEECH_TAG_MAPPINGS.put("N",	"N");
		PART_OF_SPEECH_TAG_MAPPINGS.put("P",	"P");
		PART_OF_SPEECH_TAG_MAPPINGS.put("V",	"V");
		PART_OF_SPEECH_TAG_MAPPINGS.put("ADV",	"ADV");
		PART_OF_SPEECH_TAG_MAPPINGS.put("ET",	"ET");
		PART_OF_SPEECH_TAG_MAPPINGS.put("A",	"A");
		PART_OF_SPEECH_TAG_MAPPINGS.put("CL",	"CL");
