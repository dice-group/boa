...
public class NamedEntityTagNormalizer {
	...
	static {
		...
		// misc
		NAMED_ENTITY_TAG_MAPPINGS.put("B-MISC",	Constants.NAMED_ENTITY_TAG_MISCELLANEOUS);
		NAMED_ENTITY_TAG_MAPPINGS.put("I-MISC",	Constants.NAMED_ENTITY_TAG_MISCELLANEOUS);
		NAMED_ENTITY_TAG_MAPPINGS.put("MISC",	Constants.NAMED_ENTITY_TAG_MISCELLANEOUS);
