...
public class DefaultMachineLearningTrainingFileEntry extends AbstractMachineLearningTrainingFileEntry {
     ...
     * @param annotation
     */
    public DefaultMachineLearningTrainingFileEntry(String patternMappingUri, String naturalLanguageRepresentation, List<Double> featureVector, Boolean annotation) {

        super(patternMappingUri, naturalLanguageRepresentation, featureVector, annotation);
    }
