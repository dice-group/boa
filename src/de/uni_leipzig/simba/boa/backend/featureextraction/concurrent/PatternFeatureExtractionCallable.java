...
public class PatternFeatureExtractionCallable extends BoaCallable<PatternMappingPatternPair> {
	...
	public Collection<PatternMappingPatternPair> call() {
		...
		for ( FeatureExtractor feature : featureExtractors ) {
			...
			this.logger.info(feature.getClass().getSimpleName() + " from " + this.getName() + " finished in " + TimeUtil.convertMilliSeconds(System.currentTimeMillis() - start) + "ms!");
		}
