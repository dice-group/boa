...
public class PatternTable extends Table {
	...
	public static final Object[] NATURAL_COL_ORDER = new Object[] {
		 "id",	"confidence",	"globalConfidence"	, "similarity" ,"support",	"typicity",	"specificity",	"naturalLanguageRepresentation", "posTaggedString",	"numberOfOccurrences"};

	public static final String[] COL_HEADERS_ENGLISH = new String[] {
		 "id",	"CONF",			"GCONF"				, "SIM"			,"SUPP",	"TYP",		"SPEC",			"NLR", 							 "POS tags", 		"OCC" };
...
//		setPageLength(Math.max(15, dataSource.size()));
		...
		setColumnWidth(NATURAL_COL_ORDER[9],50);
